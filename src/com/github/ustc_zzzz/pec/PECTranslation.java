...
public class PECTranslation
{
    ...
    public PECTranslation(ParticleEffectCombinator plugin)
    {
    ...
    private Asset getAsset(ParticleEffectCombinator p, AssetManager manager, String one, String other) throws IOException
    {
