...
import com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.function.Function;
import com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.function.Functions;
import com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.operator.Operator;
import com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.shuntingyard.ShuntingYard;
...
public class ExpressionBuilder
{
    ...
    /**
     * Add a {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.function.Function} implementation available for use in the expression
     *
     * @param function the custom {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.function.Function} implementation that should be available for use in the expression.
    ...
    /**
     * Add multiple {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.function.Function} implementations available for use in the expression
     *
     * @param functions the custom {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
     ...
     * Add multiple {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.function.Function} implementations available for use in the expression
     *
     * @param functions A {@link java.util.List} of custom {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add an {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.operator.Operator} which should be available for use in the expression
     *
     * @param operator the custom {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.operator.Operator} to add
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add multiple {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.operator.Operator} implementations which should be available for use in the expression
     *
     * @param operators the set of custom {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
     ...
     * Add multiple {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.operator.Operator} implementations which should be available for use in the expression
     *
     * @param operators the {@link java.util.List} of custom {@link com.github.ustc_zzzz.particlecombinator.util.repackage.net.objecthunter.exp4j.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
